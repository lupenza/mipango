...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Account types</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">List</a></li>
                            <li class="breadcrumb-item active">Account types List</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body ">
                        <h4 class="card-title text-center" >Account Types</h4>
                        <div style="display: flex; flex-direction: row; justify-content:flex-end; padding: 5px 0px 5px 0px">
                            <button class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal"> <span class="fa fa-plus font-size-15"></span> Add Account </button>
                        </div>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $account->name }}</td>
                                        <td>{{ $account->name_sw }}</td>
                                        <td>{{ $account->description }}</td>
                                        <td>
                                                <button class="btn btn-success btn-sm edit-btn" data-uuid="{{ $account->uuid}}" data-name="{{ $account->name}}"
                                                    data-name_sw ="{{ $account->name_sw}}" data-desc ="{{ $account->description }}" data-bs-toggle="modal" data-bs-target="#myModal1"> <span class="fa fa-edit"></span></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Register Account</h5>
            ...
            <div class="modal-body">
               <form id="registration_form">
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <label for="Name">Swahil Name</label>
                        <input type="text" class="form-control" name="name_sw" placeholder="Write Account type name in swahili....." required>
                    </div>
                    <div class="col-md-12">
 ...
 <div id="myModal1" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Account Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
               <form id="update_form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <label for="Name">Swahil Name</label>
                        <input type="text" id="name_sw" class="form-control" name="name_sw" required>
                    </div>
                    <div class="col-md-12">
                        <label for="Name">Description</label>
